...
|----------|-------|----------------|-------------------------------|
| `unspecified-low` | gpt-5.6-luna | Mid-tier, simplicity-leaning, structure-demolishing | Pragmatist Skeptic -- model bias toward simplicity makes it the natural enemy of over-engineering |
| `unspecified-high` | gpt-5.6-luna | High-effort, broad-impact, coordination-software | Integration Tester -- max-tier broad-scope thinking exposes cross-module fragility |
