...
@Entity
@Table(name = "dlt_store", schema = "order_svc")
...
public class DurableDltJpaEntity {
    ...
    public DurableDltJpaEntity(String topic, int partition, long offset, String recordKey, String payload,
                               String payloadHash, String reason, int attempts, Instant firstSeen) {
