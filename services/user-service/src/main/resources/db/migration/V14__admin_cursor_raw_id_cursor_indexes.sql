...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_buyer_profiles_admin_name_keycloak_raw_v14
    ON user_svc.buyer_profiles (lower(coalesce(name, '')), keycloak_id);
DROP INDEX CONCURRENTLY IF EXISTS user_svc.idx_buyer_profiles_admin_name_keycloak;
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_seller_profiles_admin_pending_created_keycloak_raw_v14
    ON user_svc.seller_profiles (approved, created_at DESC, keycloak_id DESC);
DROP INDEX CONCURRENTLY IF EXISTS user_svc.idx_seller_profiles_admin_pending_created_keycloak;
